...
export default function EditorialCategories() {
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 bg-[#0a0a0a] overflow-hidden relative">
      <div className="max-w-[1800px] mx-auto px-6 md:px-16 relative z-10">
        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }} className="flex flex-col md:flex-row justify-between items-end gap-12 mb-24 relative z-20">
          <div className="max-w-2xl">
            ...
            <h2 className="leading-[0.85]">
              <span className="heading-mixed text-white block">Shop By</span>
              <span className="heading-mixed-italic text-[#8e9192] block">Category.</span>
            </h2>
          </div>
