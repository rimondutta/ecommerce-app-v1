          ...
          <div className="lg:col-span-5 lg:sticky lg:top-[100px] lg:self-start">
            <div className="space-y-8">
              <div className="flex items-center gap-3">
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-black/70 border border-black/10 px-3 py-1.5">
              ...
              <p className="text-sm leading-[1.8] text-black/80 font-medium tracking-wide max-w-md border-l-2 border-black/10 pl-4">
              ...
              {product.colors?.length > 0 && (
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[11px] font-medium text-black/60 tracking-wide">{selectedColor?.name || "Select"}</span>
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center border-2 border-black/10 w-fit">
                  ...
                  <span className="w-14 text-center text-[15px] font-black tabular-nums">{quantity}</span>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-3 px-4 py-4 min-h-[52px] border-2 transition-all active:scale-[0.98] ${(product.sizes?.length > 0 && !selectedSize) || (product.colors?.length > 0 && !selectedColor)
